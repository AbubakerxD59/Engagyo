...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $menus = [
            ...
            ["id" => "4", "name" => "Analytics", "icon" => "fas fa-chart-line", "route" => "panel.analytics", "display_order" => "4"],
            ...
            ["id" => "7", "name" => "Accounts", "icon" => "fas fa-user-circle", "route" => "panel.accounts", "display_order" => "7"],
        ];
