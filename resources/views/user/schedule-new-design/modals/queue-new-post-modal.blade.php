                    ...
                    <div class="create-post-editor-wrap" id="queueNewPostEditorWrap" style="display: none;">
                        <div>
                            ...
                            <div class="create-post-instagram-format-wrap create-post-facebook-format-wrap"
                                id="queueNewPostInstagramFormatWrap" style="display: none;"
                                role="group" aria-label="Instagram content format">
                                <div class="create-post-facebook-format-bar">
                                    ...
                                    <div class="create-post-instagram-format-radios create-post-facebook-format-radios">
                                        <label class="create-post-format-option">
                                            <input type="checkbox" name="create_post_instagram_formats[]"
                                                id="queueNewPostFormatIgPost" value="post" checked>
                                            <span>Post</span>
                                        </label>
                                        <label class="create-post-format-option">
                                            <input type="checkbox" name="create_post_instagram_formats[]"
                                                id="queueNewPostFormatIgStory" value="story">
                                            <span>Story</span>
                                        </label>
                                        <label class="create-post-format-option">
                                            <input type="checkbox" name="create_post_instagram_formats[]"
                                                id="queueNewPostFormatIgCarousel" value="carousel">
                                            <span>Carousel</span>
                                        </label>
                                    </div>
                            ...
                            <div class="create-post-instagram-format-wrap create-post-facebook-format-wrap"
                                id="queueNewPostThreadsFormatWrap" style="display: none;"
                                    ...
                                    <div class="create-post-instagram-format-radios create-post-facebook-format-radios">
                                        <label class="create-post-format-option">
                                            <input type="checkbox" name="create_post_threads_formats[]"
                                                id="queueNewPostFormatThPost" value="post" checked>
                                            <span>Post</span>
                                        </label>
                                        <label class="create-post-format-option">
                                            <input type="checkbox" name="create_post_threads_formats[]"
                                                id="queueNewPostFormatThCarousel" value="carousel">
                                            <span>Carousel</span>
                                        </label>
                                    </div>
                                    <div class="create-post-format-help-wrap" id="queueNewPostThreadsFormatHelpWrap">
                                        <button type="button" class="create-post-format-help-btn"
                                            id="queueNewPostThreadsFormatHelpBtn">
                                            <i class="far fa-question-circle"></i>
                                        </button>
                                        <div class="create-post-format-help-popover" role="tooltip"
                                            aria-hidden="true">
                            ...
                            <div class="create-post-instagram-format-wrap create-post-facebook-format-wrap"
                                id="queueNewPostLinkedinFormatWrap" style="display: none;"
                                ...
                                <div class="create-post-facebook-format-bar">
                                    ...
                                    <div class="create-post-instagram-format-radios create-post-facebook-format-radios">
                                        <label class="create-post-format-option">
                                            <input type="checkbox" name="create_post_linkedin_formats[]"
                                                id="queueNewPostFormatLiPost" value="post" checked>
                                            <span>Post</span>
                                        </label>
                                        <label class="create-post-format-option">
                                            <input type="checkbox" name="create_post_linkedin_formats[]"
                                    ...
                                    <div class="create-post-format-help-wrap" id="queueNewPostLinkedinFormatHelpWrap">
                                        <button type="button" class="create-post-format-help-btn"
                                            id="queueNewPostLinkedinFormatHelpBtn">
                                            <i class="far fa-question-circle"></i>
                                        </button>
                                        <div class="create-post-format-help-popover" role="tooltip"
                                            aria-hidden="true">
                            ...
                            <div id="queueNewPostTikTokSettingsWrap" class="mt-3" style="display:none;">
                                <div class="border rounded p-3" style="background:#f8fafc;color:#1f2937;border-color:#e5e7eb !important;">
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <label class="mb-0 d-flex align-items-center mt-2" id="queueNewPostTikTokDuetWrap">
                                            <input type="checkbox" id="queueNewPostTikTokAllowDuet" class="mr-2">
                                            <span>Duet</span>
                                        </label>
                                        <label class="mb-0 d-flex align-items-center mt-2" id="queueNewPostTikTokStitchWrap">
                                            <input type="checkbox" id="queueNewPostTikTokAllowStitch" class="mr-2">
                                            <span>Stitch</span>
                                        </label>
                                    </div>
