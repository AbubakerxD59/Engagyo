        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('panel.schedule.new-design') }}">Schedule</a></li>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('panel.schedule.new-design') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="test-step mb-4 p-3 rounded border
                    ...
                    <div class="d-flex align-items-center mb-2">
                        <span class="badge
                            ...
                            mr-2">Step {{ $step['id'] }}</span>
                        <h5 class="mb-0">{{ $step['title'] }}</h5>
                        <span class="badge badge-{{ $step['status'] === 'success' ? 'success' : ($step['status'] === 'error' ? 'danger' : 'info') }} ml-2">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <dl class="row">
                    ...
                    <dd class="col-sm-9">
                        @if($post->status == 1) <span class="badge badge-success">Published</span>
                        @elseif($post->status == -1) <span class="badge badge-danger">Failed</span>
