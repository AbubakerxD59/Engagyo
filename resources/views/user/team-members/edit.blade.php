            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('panel.team-members.update', $teamMember->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')

                                    <div class="form-group">
                                        <label>Email Address</label>
                                        <input type="email" class="form-control" value="{{ $teamMember->email }}"
                                            disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ ucfirst($teamMember->status) }}" disabled>
                                    </div>
                                                ...
                                                <div class="features-container"
                                                    ...
                                                    @if ($features->count() > 0)
                                                        @foreach ($features as $feature)
                                                            @php
                                                                $memberLimit = $teamMember->featureLimits
                                                                    ->where('feature_id', $feature->id)
                                                                    ->first();
                                                                $limitValue = $memberLimit
                                                                    ? $memberLimit->limit_value
                                                                    : '';
                                                            @endphp
                                                    ...
                                                    <div class="accounts-grid-wrapper">
                                                        <div class="accounts-grid" data-platform="facebook">
                                                            @foreach ($facebookAccounts as $account)
                                                                ...
                                                                @endphp
                                                                <article
                                                                    class="account-card facebook-card account-select-card has-tooltip {{ $hasAccess ? 'selected' : '' }}"
                                                    ...
                                                    <div class="accounts-grid-wrapper">
                                                        <div class="accounts-grid" data-platform="pinterest">
                                                            @foreach ($pinterestAccounts as $account)
                                                                ...
                                                                @endphp
                                                                <article
                                                                    class="account-card pinterest-card account-select-card has-tooltip {{ $hasAccess ? 'selected' : '' }}"
                                                                    data-account-id="{{ $account['id'] }}"
                                                                    data-account-type="{{ $account['type'] }}"
                                                                    data-tooltip="{{ $account['username'] }}">
                                                                    <div class="account-card-accent"></div>
                                                    ...
                                                    <div class="accounts-grid-wrapper">
                                                        <div class="accounts-grid" data-platform="tiktok">
                                                            @foreach ($tiktokAccounts as $account)
                                                                ...
                                                                @endphp
                                                                <article
                                                                    class="account-card tiktok-card account-select-card has-tooltip {{ $hasAccess ? 'selected' : '' }}"
                                                                    data-account-id="{{ $account['id'] }}"
                                                                    data-account-type="{{ $account['type'] }}"
                                                                    data-tooltip="{{ $account['username'] }}">
                                                                    <div class="account-card-accent"></div>
                                                    ...
                                                    <div class="accounts-grid-wrapper">
                                                        <div class="accounts-grid" data-platform="threads">
                                                            @foreach ($threadsAccounts as $account)
                                                                ...
                                                                @endphp
                                                                <article
                                                                    class="account-card threads-card account-select-card has-tooltip {{ $hasAccess ? 'selected' : '' }}"
                                                                    data-account-id="{{ $account['id'] }}"
                                                                    data-account-type="{{ $account['type'] }}"
                                                                    data-tooltip="{{ $account['username'] }}">
                                                                    <div class="account-card-accent"></div>
                                                    ...
                                                    <div class="accounts-grid-wrapper">
                                                        <div class="accounts-grid" data-platform="linkedin">
                                                            @foreach ($linkedinAccounts as $account)
                                                                ...
                                                                @endphp
                                                                <article
                                                                    class="account-card linkedin-card account-select-card has-tooltip {{ $hasAccess ? 'selected' : '' }}"
                                                                    data-account-id="{{ $account['id'] }}"
                                                                    data-account-type="{{ $account['type'] }}"
                                                                    data-tooltip="{{ $account['username'] }}">
                                                                    <div class="account-card-accent"></div>
