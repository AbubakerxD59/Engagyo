        ...
        <div class="content-header clearfix">
            <h1 class="float-left">Test Case Details
                <small>
                    ...
                    <a href="{{ route('admin.tiktok-tests.index') }}">back to Test Cases list</a>
                </small>
            </h1>
        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <table class="table table-bordered">
                                            <tr>
                                                <th width="40%">TikTok Account</th>
                                                <td>
                                                    @if ($testCase->tiktokAccount)
                                                        {{ $testCase->tiktokAccount->display_name ?? $testCase->tiktokAccount->username }}
                                                    @else
                                                        N/A
                                                    @endif
                                                </td>
                                                    ...
                                                    @if ($testCase->testPost)
                                                        <a href="#" target="_blank">
                                                            ...
                                                            @if ($testCase->testPost->post_id)
                                                                (TikTok ID: {{ $testCase->testPost->post_id }})
                                                            @endif
                                                        </a>
                                                    @else
                                                        N/A
