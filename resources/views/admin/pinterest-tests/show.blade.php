        ...
        <div class="content-header clearfix">
            <h1 class="float-left">Test Case Details
                <small>
                    ...
                    <a href="{{ route('admin.pinterest-tests.index') }}">back to Test Cases list</a>
                </small>
            </h1>
        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <table class="table table-bordered">
                                            <tr>
                                                <th width="40%">Pinterest Board</th>
                                                <td>
                                                    @if ($testCase->pinterestBoard)
                                                        {{ $testCase->pinterestBoard->name }}
                                                    @else
                                                        N/A
                                                    @endif
                                                </td>
                                                    ...
                                                    @if ($testCase->testPost)
                                                        <a href="#" target="_blank">
                                                            ...
                                                            @if ($testCase->testPost->post_id)
                                                                (Pinterest ID: {{ $testCase->testPost->post_id }})
                                                            @endif
                                                        </a>
                                                    @else
                                                        N/A
