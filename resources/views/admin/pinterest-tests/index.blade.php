...
@section('page_title', 'Pinterest Test Cases')
@section('page_content')
    <div class="page-content">
        <div class="content-header clearfix">
            <h1 class="float-left">Pinterest Test Cases</h1>
                                                ...
                                                <table class="table table-striped table-bordered" id="dataTable">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-data="board_name">Board</th>
...
@push('scripts')
    <script type="text/javascript">
        let table = $('#dataTable').DataTable({
            ...
            "serverSide": true,
            ajax: {
                url: "{{ route('admin.pinterest-tests.dataTable') }}",
                data: function(d) {
        ...
        $('#runTestsBtn').on('click', function() {
            ...
            $.ajax({
                url: "{{ route('admin.pinterest-tests.run') }}",
                method: 'POST',
                headers: {
