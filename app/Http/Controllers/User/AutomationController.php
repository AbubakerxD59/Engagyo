...
class AutomationController extends Controller
{
    ...
    public function posts(Request $request)
    {
        ...
        foreach ($posts as $k => $val) {
            ...
            $posts[$k]['account_name'] = "<a href='" . $val->getAccountUrl($val->social_type, $val->account_id) . "' target='_blank'><img src='" . social_logo($val->type) . "' width='20px' height='20px'></img> " . $val->getAccount($val->type, $val->account_id)->name . "</a>";
